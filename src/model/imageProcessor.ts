...
////test.sqlite3.tsからgetDcmDSをimport
...
//  //test.sqlite3に格納されているdcmDSから、imageStructureを作成する
//  createImageStructureFromDB(assignID: UUID): ImageStructure | null {
//    let imgStructure: ImageStructure | null = null; 
//    try {
//      //getDcmDSを実行し、dcmDSを取得
//      getDcmDS(assignID, (err, dcmDS) => {
//        //dcmDSからimageStructureを作成
//        if (err || dcmDS === null) {
//          return null;
//        }
//        imgStructure = this.getImgInfoFromDICOM(dcmDS);
//      });  
//      return imgStructure;
//    } catch (error) {
//      return null; 
